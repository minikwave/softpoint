...
| P0-5 | Admin 나머지 write 감사 누락 점검 | **부분 완료**: 전환 approve/settle/fail 전 `before` 스냅샷 + 404 시 감사; 나머지 write 경로는 점검 지속 |
...
| M1-3 | 디앱 **적립·전체 내역**에 출처 표시·필터 | **출처 표시**: EarnHistory, Transactions; **필터**는 미구현 |
